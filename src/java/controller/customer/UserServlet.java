...
public class UserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            switch (action) {
                case "add":
                    // Load dropdown Role + Status
                    request.setAttribute("roles", dao.getAllRoles());
                    request.setAttribute("statuses", dao.getAllStatuses());
                    request.getRequestDispatcher("/views/manager/user_add.jsp").forward(request, response);
                    return;
                ...
                case "edit":
                    ...
                    request.setAttribute("roles", dao.getAllRoles());
                    request.setAttribute("statuses", dao.getAllStatuses());
                    request.getRequestDispatcher("/views/manager/user_edit.jsp").forward(request, response);
                    return;
    ...
    private void listUsers(HttpServletRequest request, HttpServletResponse response, UserDao dao)
        ...
        request.getRequestDispatcher("/views/manager/user_list.jsp").forward(request, response);
    }
    ...
    public String getServletInfo() {
        return "User Management Servlet — list, add, edit, search, and filter users";
    }
}
