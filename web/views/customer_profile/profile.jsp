                    ...
                    <div class="container mt-4">
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3">
                            <c:forEach var="fav" items="${favoriteList}">
                                <div class="col">
                                    <div class="card favorites-card h-100 shadow-sm border-0 rounded-4">

                                        <div class="card-banner">
                                            <img  src="${pageContext.request.contextPath}/views/home/images/Servie_Term_Pic.jpg" alt="${fav.serviceType}" class="img-fluid w-100">
                                        </div>
                                        <div class="card-body d-flex flex-column justify-content-between p-2">
                                            <div class="fav-text d-flex flex-column " >
                                                <p class="fw-bold text-capitalize mb-1">${fav.serviceType}</p>
            ...
            © 2025 <span class="text-warning">Meland Travel</span>. All rights reserved.
                    ...
                    <script>
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            if (defaultMenuLink)
                                defaultMenuLink.classList.add("active");
                        });
