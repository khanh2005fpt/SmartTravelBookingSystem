        ...
        <div class="main-content">
            ...
            <div class="search-bar">
                <form action="${pageContext.request.contextPath}/staff/islands" method="get" class="row g-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label btn-sear fw-bold">Tìm kiếm</label>
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        <button type="submit" class="btn btn-success w-100"><i class="fa fa-search"></i> Tìm kiếm</button>
                    </div>
                </form>
            </div>
