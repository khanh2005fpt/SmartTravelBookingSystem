...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <h1><i class="fa fa-utensils"></i> Quản lý Nhà hàng</h1>
            <p>Quản lý danh sách nhà hàng và dịch vụ ăn uống</p>
        </div>
        ...
        <div class="restaurants-container">
            <div class="restaurants-header">
                <h3 class="restaurants-title">
                    <i class="fa fa-list"></i> Danh sách Nhà hàng
                </h3>
                <div style="display: flex; align-items: center; gap: 15px;">
                    <span class="restaurants-count">
                        ${not empty restaurants ? restaurants.size() : 0} nhà hàng
                    </span>
                    <a href="${pageContext.request.contextPath}/staff/restaurants?action=create" class="btn-add">
                        <i class="fa fa-plus"></i> Thêm nhà hàng
                    </a>
                </div>
            </div>
            ...
            <c:choose>
                <c:when test="${not empty restaurants}">
                    <div class="table-responsive">
                        <table class="restaurants-table table">
                            <thead>
                                <tr>
                                    <th>Hình ảnh</th>
                                    ...
                                    <tr>
                                        <td>
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <div class="restaurant-image" style="background: #f8f9fa; display: flex; align-items: center; justify-content: center; color: #6c757d;">
                                        ...
                                        <td>
                                            ...
                                            <div class="restaurant-cuisine">
                                                <c:if test="${not empty restaurant.address}">
                                                    <i class="fa fa-map-marker-alt"></i> ${restaurant.address}
                                                </c:if>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="${pageContext.request.contextPath}/staff/restaurants?action=view&id=${restaurant.restaurantId}" 
                                                   class="btn-action btn-view" title="Xem chi tiết">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="${pageContext.request.contextPath}/staff/restaurants?action=edit&id=${restaurant.restaurantId}" 
                                                   class="btn-action btn-edit" title="Chỉnh sửa">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="#" onclick="confirmDelete(${restaurant.restaurantId}, '${restaurant.restaurantName}')" 
                            ...
                            <nav>
                                <ul class="pagination">
                                    <c:if test="${currentPage > 1}">
                                        <li class="page-item">
                                            <a class="page-link" href="?action=list&page=${currentPage - 1}&search=${param.search}&cuisineType=${param.cuisineType}&islandId=${param.islandId}">
                                    ...
                                    <c:forEach begin="1" end="${totalPages}" var="pageNum">
                                        <li class="page-item ${pageNum == currentPage ? 'active' : ''}">
                                            <a class="page-link" href="?action=list&page=${pageNum}&search=${param.search}&cuisineType=${param.cuisineType}&islandId=${param.islandId}">
                                                ${pageNum}
                                            </a>
                                        </li>
                                    </c:forEach>
                ...
                <c:otherwise>
                    <div class="empty-state">
                        ...
                        <p>Hiện tại chưa có nhà hàng nào trong hệ thống.</p>
                        <a href="${pageContext.request.contextPath}/staff/restaurants?action=create" class="btn-add">
                            <i class="fa fa-plus"></i> Thêm nhà hàng đầu tiên
                        </a>
                    </div>
                </c:otherwise>
            </c:choose>
