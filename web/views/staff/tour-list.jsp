<%-- 
    Document   : tour-list
    Created on : Staff Tour List Page
    Author     : System
    Description: Displays paginated list of tours with search and management functionality
--%>
...
<head>
    ...
    <title>Quản lý Tour - Meland Travel</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <h1><i class="fa fa-map-marker"></i> Quản lý Tour</h1>
            <p>Quản lý và theo dõi tất cả các tour du lịch</p>
        </div>
        ...
        <div class="search-section">
            <div class="row">
                <div class="col-md-8">
                    <form action="${pageContext.request.contextPath}/staff/tours" method="get" class="d-flex">
                            ...
                            <div class="tour-card">
                                <div class="tour-card-body">
                                    ...
                                    <p class="tour-description">
                                        <c:choose>
                                            <c:when test="${tour.description.length() > 100}">
                    ...
                    <div class="pagination-wrapper">
                        ...
                        <div class="text-center mt-3">
                            <small class="text-muted">
                                ...
                                ${currentPage * pageSize > totalTours ? totalTours : currentPage * pageSize} 
                                trong tổng số ${totalTours} tour
                            </small>
                        </div>
                    </div>
                </c:if>
                    ...
                    <p class="text-muted">
                        <c:choose>
                            <c:when test="${not empty param.search}">
                                Không tìm thấy tour nào với từ khóa "${param.search}"
                            </c:when>
                            <c:otherwise>
                                Chưa có tour nào được tạo. Hãy tạo tour đầu tiên!
                            </c:otherwise>
                        </c:choose>
                    </p>
                    <a href="${pageContext.request.contextPath}/staff/tours?action=create" 
