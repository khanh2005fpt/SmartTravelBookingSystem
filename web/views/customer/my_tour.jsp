...
<%@ page import="model.HistoryBooking" %>
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="container py-5" style="max-width: 1800px;">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                        ...
                        <c:choose>
                            <c:when test="${not empty historyBooking}">
                                <%-- Kiểm tra loại tour --%>
                                <c:choose>

                                    <%-- Tour Lẻ --%>
                                    <c:when test="${historyBooking.tourType == 'Tour lẻ'}">
                                        <!-- Tour Info -->
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <p class="mb-0"><strong>Tổng giá:</strong>
                                                        <span class="badge bg-primary text-white ms-2 price-badge">
                                                            <fmt:formatNumber value="${tour.totalPrice}" type="number" groupingUsed="true"/> VND
                                                        </span>
                                                    </p>
                                                </div>
                                        ...
                                        <div class="card mb-4 shadow-sm p-3">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary fw-bold mb-3">Dịch vụ đã đặt</h5>
                                                    ...
                                                    <div class="card-body p-2 ">
                                                        <div class="card-header d-flex flex-column align-items-center"
                                                            ...
                                                            <h6 class="fw-bold mb-1" style="font-size: 20px;">
                                                                ${flightSchedulesCT.flight.flightNumber} - ${flightSchedulesCT.planeModel}
                                                            </h6>
                                                            <p class="small mb-0" style="opacity: 0.8;">
                                                                ${flightSchedulesCT.departureAirport} → ${flightSchedulesCT.arrivalAirport}
                                                            </p>
                                                        </div>
                                                        <!-- Giờ khởi hành -->
                                                        <div class="row text-center border-top border-bottom py-2 my-2">
                                                            <div class="col-5">
                                                                <h6 class="fw-bold mb-0" style="color: #1976d2;">${flightSchedulesCT.departureTime}</h6>
                                                                <small>${flightSchedulesCT.departureAirport}</small>
                                                            </div>
                                                            <div class="col-2 d-flex align-items-center justify-content-center">
                                                                <i class="fa fa-plane" style="color: #1976d2;"></i>
                                                            </div>
                                                            <div class="col-5">
                                                                <h6 class="fw-bold mb-0" style="color: #1976d2;">${flightSchedulesCT.arrivalTime}</h6>
                                                                <small>${flightSchedulesCT.arrivalAirport}</small>
                                                            </div>
                                                        </div>
                                                        <!-- Chiều về -->
                                                        <c:if test="${not empty flightSchedulesCT.returnDepartureTime}">
                                                            <div class="row text-center border-top border-bottom py-2 my-2 bg-light rounded-3">
                                                                <div class="col-5">
                                                                    <h6 class="text-secondary fw-bold mb-0">${flightSchedulesCTs.returnDepartureTime}</h6>
                                                                    <small>${flightSchedulesCT.arrivalAirport}</small>
                                                                </div>
                                                                <div class="col-2 d-flex align-items-center justify-content-center">
                                                                ...
                                                                <div class="col-5">
                                                                    <h6 class="text-secondary fw-bold mb-0">${flightSchedulesCT.returnArrivalTime}</h6>
                                                                    <small>${flightSchedulesCT.departureAirport}</small>
                                                                </div>
                                                            </div>
                                                        </c:if>
                                                        <!-- Transit -->
                                                        <c:if test="${not empty flightSchedulesCT.transitAirport}">
                                                            <p class="small mb-2">
                                                                <i class="bi bi-clock-history me-1" style="color: #1976d2; font-size: 1.1rem;"></i>
                                                                Trung chuyển tại: <strong>${flightSchedulesCT.transitAirport}</strong> - <strong>(${flightSchedulesCT.transitDuration})</strong>
                                                            </p>
                                                        </c:if>
                                                        <!-- Notes -->
                                                        <c:if test="${not empty flightSchedulesCT.cabinBaggage}">
                                                            <p class="small fst-italic mb-3">
                                                                <i class="bi bi-suitcase me-1" style="color: #1976d2; font-size: 1.05rem;"></i>
                                                                Hành lý xách tay cho phép : <strong>${flightSchedulesCT.cabinBaggage}</strong> - <strong>${flightSchedulesCT.flight.flightClass}</strong>
                                                            </p>
                                                        </c:if>
                                                        <c:if test="${not empty flightSchedulesCT.seatCapacity}">
                                                            <p class="small fst-italic mb-3">
                                                                <i class="bi bi-person-lines-fill me-1" style="color: #1976d2; font-size: 1.05rem;"></i>
                                                                Sức chứa : <strong>${flightSchedulesCT.seatCapacity} ghế </strong>
                                                            </p>
                                                        </c:if>
                                                        <c:if test="${not empty flightSchedulesCT.notes}">
                                                            <p class="small fst-italic mb-3">
                                                                <i class="bi bi-chat-left-text me-1" style="color: #1976d2; font-size: 1.05rem;"></i>
                                                                ${flightSchedulesCT.notes}
                                                            </p>
                                                        </c:if>
                            ...
                            <%----------------------------------- ----Tour Trọn Gói -------------------------------------------------%>
                            <c:when test="${historyBooking.tourType == 'Tour trọn gói'}">
                                <%-- Tour Info --%>
                                <div class="card hero-card shadow-sm mb-4 p-4">
                                    <div class="d-flex align-items-start gap-3">
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="mb-1"><i class="bi bi-calendar-event me-2"></i>
                                                ...
                                                <span class="text-muted">${booking.departureDate}</span>
                                            </p>
                                            <p class="mb-0"><strong>Tổng giá:</strong>
                                                <span class="badge bg-primary text-white ms-2 price-badge">
        ...
        <span class="text-primary" style="font-size: 15px;">
          ${act.description}
                    ...
                    <%-- Flight Schedule Tour --%>
                    <h5 class="text-primary fw-bold mb-3 mt-3"> <i class="bi bi-airplane-fill me-2"></i> Lịch trình chuyến bay</h5>
                    <div class="row mb-2">
                        <c:choose>
                            <c:when test="${not empty flightSchedulesT}">
                                <div class="col-lg-12 col-md-6 col-sm-6">
                                    <div class="card shadow-sm border-0 rounded-3 flight-card h-100">
                                        <div class="card-body p-2 ">
                                            <div class="card-header d-flex flex-column align-items-center"
                                                 ...
                                                 max-height: 100%;">
                                                <h6 class="fw-bold mb-1" style="font-size: 20px;">
                                                    ${flightSchedulesT.flight.flightNumber} - ${flightSchedulesT.planeModel}
                                                </h6>
                                                <p class="small mb-0" style="opacity: 0.8;">
                                                    ${flightSchedulesT.departureAirport} → ${flightSchedulesT.arrivalAirport}
                                                </p>
                                            </div>
                                            <!-- Giờ khởi hành -->
                                            <div class="row text-center border-top border-bottom py-2 my-2">
                                                <div class="col-5">
                                                    <h6 class="fw-bold mb-0" style="color: #1976d2;">${flightSchedulesT.departureTime}</h6>
                                                    <small>${flightSchedulesT.departureAirport}</small>
                                                </div>
                                                <div class="col-2 d-flex align-items-center justify-content-center">
                                                    <i class="fa fa-plane" style="color: #1976d2;"></i>
                                                </div>
                                                <div class="col-5">
                                                    <h6 class="fw-bold mb-0" style="color: #1976d2;">${flightSchedulesT.arrivalTime}</h6>
                                                    <small>${flightSchedulesT.arrivalAirport}</small>
                                                </div>
                                            </div>
                                            <!-- Chiều về -->
                                            <c:if test="${not empty flightSchedulesT.returnDepartureTime}">
                                                <div class="row text-center border-top border-bottom py-2 my-2 bg-light rounded-3">
                                                    <div class="col-5">
                                                        <h6 class="text-secondary fw-bold mb-0">${flightSchedulesT.returnDepartureTime}</h6>
                                                        <small>${flightSchedulesT.arrivalAirport}</small>
                                                    </div>
                                                    <div class="col-2 d-flex align-items-center justify-content-center">
                                                        <i class="fa fa-plane text-secondary" style="transform: rotate(180deg);"></i>
                                                    ...
                                                    <div class="col-5">
                                                        <h6 class="text-secondary fw-bold mb-0">${flightSchedulesT.returnArrivalTime}</h6>
                                                        <small>${flightSchedulesT.departureAirport}</small>
                                                    </div>
                                                </div>
                                            </c:if>
                                            <!-- Transit -->
                                            <c:if test="${not empty flightSchedulesT.transitAirport}">
                                                <p class="small mb-2">
                                                    <i class="bi bi-clock-history me-1" style="color: #1976d2; font-size: 1.1rem;"></i>
                                                    Trung chuyển tại: <strong>${flightSchedulesT.transitAirport}</strong> - <strong>(${flightSchedulesT.transitDuration})</strong>
                                                </p>
                                            </c:if>
                                            <!-- Notes -->
                                            <c:if test="${not empty flightSchedulesT.cabinBaggage}">
                                                <p class="small fst-italic mb-3">
                                                    <i class="bi bi-suitcase me-1" style="color: #1976d2; font-size: 1.05rem;"></i>
                                                    Hành lý xách tay cho phép : <strong>${flightSchedulesT.cabinBaggage}</strong> - <strong>${flightSchedulesT.flight.flightClass}</strong>
                                                </p>
                                            </c:if>
                                            <c:if test="${not empty flightSchedulesT.seatCapacity}">
                                                <p class="small fst-italic mb-3">
                                                    <i class="bi bi-person-lines-fill me-1" style="color: #1976d2; font-size: 1.05rem;"></i>
                                                    Sức chứa : <strong>${flightSchedulesT.seatCapacity} ghế </strong>
                                                </p>
                                            </c:if>
                                            <c:if test="${not empty flightSchedulesT.notes}">
                                                <p class="small fst-italic mb-3">
                                                    <i class="bi bi-chat-left-text me-1" style="color: #1976d2; font-size: 1.05rem;"></i>
                                                    ${flightSchedulesT.notes}
                                                </p>
                                            </c:if>
                                            <hr class="my-3" style="border-top: 1px solid #ddd;">
                                        </div>
                ...
                <c:otherwise>
                    <p>Loại tour không xác định.</p>
                </c:otherwise>
            </c:choose>
        </c:when>

        <c:otherwise>
            <p>Không tìm thấy lịch sử chuyến đi nào gần đây.</p>
        </c:otherwise>
