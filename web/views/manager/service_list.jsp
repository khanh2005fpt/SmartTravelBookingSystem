...
<head>
    ...
    <style>
        ...
        * {
        ...
        .badge-hotel { background: #e67e22; }
        .badge-flight { background: #3498db; }
        .badge-vehicle { background: #9b59b6; }
        .badge-place { background: #1abc9c; }
...
<div class="container">
    ...
    <div class="pagination">
        <%
            ...
            if (currentPage > 1) {
        %>
            <a href="?page=<%= currentPage - 1 %><%= queryString %>"><i class="fas fa-chevron-left"></i></a>
        <%
            }
        ...
        %>
            <a href="?page=<%= currentPage + 1 %><%= queryString %>"><i class="fas fa-chevron-right"></i></a>
        <%
            }
        %>
    </div>
