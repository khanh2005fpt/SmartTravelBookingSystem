...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="toolbar">
            ...
            %>
            <a href="<%=request.getContextPath()%>/manager/user?action=add" class="btn">
                ➕ Add New User
            </a>
        </div>
    </div>
            ...
            <tbody>
                ...
                %>
                    <tr>
                        ...
                        <td>
                            <a href="<%=request.getContextPath()%>/manager/user?action=edit&id=<%=u.getUserId()%>" class="action-link">✏️ Sửa</a>
                        </td>
                    </tr>
                <%
                        }
