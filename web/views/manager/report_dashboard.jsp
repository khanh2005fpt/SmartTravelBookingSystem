...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        th { background: var(--primary); color: white; padding: 12px 14px; text-align: left; font-weight: 600; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; }
...
<div class="container">
    ...
    <!-- NÚT BACK TO DASHBOARD - CHỈ HIỂN THỊ NẾU KHÔNG PHẢI TRANG DASHBOARD -->
    <%
