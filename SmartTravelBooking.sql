...
VALUES
    ('admin1', 'admin123!', 'admin1@example.com', 'Admin', '0987654321', 1, 'ACTIVE');

-- Booking Manager
INSERT INTO Users (username, password, email, fullName, phone, roleId, status)
VALUES
    ('bookingmanager1', 'managerpass123!', 'nqaghuyyy6969@gmail.com', 'Booking Manager', '0369409004', 2, 'ACTIVE');

-- Service Provider
INSERT INTO Users (username, password, email, fullName, phone, roleId, status)
VALUES
    ('provider1', 'providerpass123!', 'provider@example.com', 'Staff', '0987654321', 4, 'ACTIVE');

-- Customer
INSERT INTO Users (username, password, email, fullName, phone, roleId, status)
VALUES
    ('quanghuy123', 'huyvipmn5', 'huynqhe182510@fpt.edu.vn', 'David Huy', '0982706236', 3, 'ACTIVE');
